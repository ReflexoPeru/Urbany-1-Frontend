...
const categories = [
  { id: 'flujos-de-trabajo', label: 'Flujos de trabajo', path: '/automation/flujos-de-trabajo' },
  { id: 'plantillas-email', label: 'Plantillas de email', path: '/automation/plantillas-email' },
  { id: 'plantillas-whatsapp', label: 'Plantillas de WhatsApp', path: '/automation/plantillas-whatsapp' },
];
...
const AutomationSidebar = ({ activeCategory }) => {
